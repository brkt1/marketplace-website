...
// type RegisterFormData = z.infer<typeof registerSchema> & { isSeller: boolean }
...
export function RegisterForm() {
  ...
  const onSubmit = async (data: Record<string, unknown>) => {
    ...
    try {
      const { error } = await signUp(data.email as string, data.password as string, data.fullName as string, data.phone as string)
